...
public class Client_test extends javax.swing.JFrame {
...
static Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public void sendDisconnect() 
    {
        ...
        {
            Logger.getLogger(Client_test.class.getName()).log(Level.SEVERE, null, e);
   ...
   /**/ this.setTitle(Name+" - Free edition");
        ...
        Logger.getLogger(Client_test.class.getName()).log(Level.SEVERE, null, ex1);
        }
        catch (IOException ex) 
        {
        try 
...
try{
    ...
    public static void main(String args[]) throws IOException {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            /*!!*/     new Client_test().setVisible(true);
